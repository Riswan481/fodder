...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/scriswan/lunaip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/scriswan/lunaip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/scriswan/lunaip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
# LINK REPOSITORY
REPO="https://raw.githubusercontent.com/scriswan/v1/main/"
...
# LINK REPOSITORY
MENUREPO="https://raw.githubusercontent.com/scriswan/v1/main/"
...
#wget -q -O slowdns.sh https://raw.githubusercontent.com/scriswan/v1/main/Dns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
}
clear
restart_system() {
